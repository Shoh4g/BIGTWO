...
/**
 * this is to build a GUI for the Big Two card game and handle all user actions
 * @author Sabyasachi Purkayastha 3035729708
 */
public class BigTwoGUI implements CardGameUI{

    private BigTwo game; // A Bigtwo card game associates with this GUI.
    ...
    private Image[][] cardImages; // An array to store the images of the card
    private Image cardBackImage; // An array to store the backimages of the cards
    private Image[] avatars; // An array to store the avatar pictures of the players
    private JTextArea chatArea; // A text area for the players to have conservation in
    private JTextField chatInput; // A text field that allows players input for conversation
	private ChatBox chatbox; //An object used to model chatArea,message Area and Chat input.
	...
	public BigTwoGUI(BigTwo game)
	{
		...
		JMenuItem Clear = new JMenuItem("Clear Msg");
        ...
        scrollableMsgArea.setPreferredSize(new Dimension(450, 300));
		...
		panel.add(scrollableMsgArea);
		panel.add(Box.createRigidArea(new Dimension(10, 4)));
   ...
   /**
     ...
     * add the text in the chatInput to chatArea when pressing the return key
     */
     ...
     * a message should be displayed in the messaging area showing it is the active player's turn
     */
    public void promptActivePlayer() {
        this.printMsg("Player " + this.activePlayer + "'s turn");
    }
    


	class ChatBox extends JPanel  implements KeyListener
	{

		private JTextField chatInput;
		private JTextArea chatArea;
		private static final int GAME_COLOUMNS = 35;
	

		public ChatBox(){
			setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));
			chatInput = new JTextField(GAME_COLOUMNS +1);
			chatInput.addKeyListener(this);
			chatArea = new JTextArea(19, GAME_COLOUMNS);
