...
public class FullHouse extends Hand
{
	...
	public Card getTopCard()
	{
		...
		this.sort();
		 ...
		 //We compare card 0 with card 2 and card 2 with 4 because for them to be FullHouse either of the two possibilities have to be equal to form one of the Triple of the Suit.
